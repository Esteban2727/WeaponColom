  ...
  return (
    <>
      <div className="Container_Header container-fluid">
        <img
          className="Container_header__imageLOGO  "
          src={image}
          alt="image logo"
        ...
        <div className="Container_Header__modals">
          <BsCart4
            className="Container_Header__buycar"
      ...
      <div className="redireccion ">
        <button
          className="edit_categorias"
          onClick={() => {
            window.location.href = "/Pistola";
          }}
        >
          {" "}
          <img
            src={pistola}
            className="edit_image_categoria"
            alt="iamge weapons"
          ></img>
        </button>
        <button
          ...
          <div className="carousel-inner">
            {bestProducts.map((p, i) => (
              <div key={i} className={`carousel-item  ${ i==0 ? 'active':'' }`}>
                <img src={p.url_image} className="d-block w-100 edit3" alt="..."></img>
              </div>
            ))}
        ...
        <ul className="dropdown-menu dropdown-menu-dark">
          ...
          <li>
            <a
              ...
              href="http://localhost:3000/Airsoft"
            >
              Airsoft
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="http://localhost:3000/Armas_traumaticas"
            >
              Armas traumáticas
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="http://localhost:3000/Bolas_de_pimienta"
            >
              Bolas de pimienta
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="http://localhost:3000/Pistola_de_aire"
            >
              Pistola de aire
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="http://localhost:3000/Neumatico"
            >
              Neumatico
            </a>
          </li>
          <li>
            <a
              className="dropdown-item"
              href="http://localhost:3000/Fogueo"
            >
              Fogueo
            </a>
          </li>
      ...
      {modal1 && (
        <div className="style_background">
          <div
            className="modal1 edit_modal_producto"
            style={{
              display: modal1 ? "flex" : "none",
              height: "300px",
              width: "700px",
            }}
          >
            <div
              ...
              style={{ backgroundColor: "rgb(161, 161, 211)" }}
            >
              ...
              <p>
                <strong>Descripción:</strong> {producto1.descripcion}
              </p>
              <p>
                <strong>Precio:</strong> {producto1.precio}
              </p>
              <p>
                <strong>Marca:</strong> {producto1.marca}
              </p>
              <p>
                <strong>Categoría:</strong> {producto1.categoria}
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="container_footer container-fluid">
        <div className="container_footer__info container-fluid">
          <img
            className="Container_header__imageLOGO1  "
            src={image}
            alt="image logo"
            style={{ width: "150px", height: "130px" }}
          ></img>
          <FaInstagram
            className="buttons_redes"
            onClick={() => {
